...
copy_tree "${ROOT_DIR}/plugins" "${PKG_DIR}/"
...
cp "${ROOT_DIR}/RELEASE_CHECKLIST.md" "${PKG_DIR}/RELEASE_CHECKLIST.md"
cp "${ROOT_DIR}/SETUP_WINDOWS.md" "${PKG_DIR}/SETUP_WINDOWS.md"
cp "${ROOT_DIR}/SETUP_MACOS.md" "${PKG_DIR}/SETUP_MACOS.md"
cp "${ROOT_DIR}/SETUP_LINUX.md" "${PKG_DIR}/SETUP_LINUX.md"
