...
const nodes = {
  ...
  visionLoopEnabled: document.getElementById("visionLoopEnabled"),
  visionLoopMaxIterations: document.getElementById("visionLoopMaxIterations"),
  visionLoopFrame: document.getElementById("visionLoopFrame"),
  visionLoopScreenshotPath: document.getElementById("visionLoopScreenshotPath"),
  visionLoopStatus: document.getElementById("visionLoopStatus"),
  visionLoopComparisons: document.getElementById("visionLoopComparisons"),
