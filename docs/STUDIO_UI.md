...
- UI responsibilities are split into browser modules under `server/ui/modules/` (`bridge_status`, `provider_management`, `workflow_engine`, `run_monitor`, `command_browser`, `voice_control`) with `app.js` as the orchestrator
