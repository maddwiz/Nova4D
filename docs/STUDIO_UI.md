...
- UI responsibilities are split into browser modules under `server/ui/modules/` (`provider_management`, `workflow_engine`, `run_monitor`, `command_browser`) with `app.js` as the orchestrator
