...
- headless c4dpy launcher
- OpenClaw extension + MCP + Python SDK

Install in minutes, run from prompts.

#OpenClaw #Cinema4D #MoGraph #AIAgents
...
- Node bridge on localhost
- C4D Python plugin poll worker
- 60+ routes (scene/material/mograph/render/io)
- headless `c4dpy` job launch + status endpoints
- OpenClaw extension + Python SDK + MCP
